...
<br />
<div align="center">
  <a href="https://github.com/sahrohit/next-static-starter" style="font-size:60px;">
   <img alt="Brand Logo" src="public/logo.avif"
   height="150"
   style="border-radius:50%" />
  </a>

  <h3 align="center">Next Static Starter</h3>
...
1. Clone the repo
   ```sh copy
   git clone https://github.com/sahrohit/next-static-starter.git
   ```
